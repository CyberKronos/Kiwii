(function () {
  ...
  var SearchCtrl = function ($scope, $state, $timeout, ionicMaterialInk, ionicMaterialMotion, LocationService, RestaurantExplorer, AutocompleteService, CRITERIA_OPTIONS, CRITERIA_DEFAULTS) {
